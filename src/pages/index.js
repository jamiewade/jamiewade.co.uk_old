            ...
            <div class={"flex flex-col bg-white text-gray-600 w-full h-full"}>
                <Content>
                    <div className={"text-center sm:mx-auto sm:max-w-2xl"}>
                        ...
                        <p className={"mb-2 sm:mb-3 sm:text-lg md:text-xl"}>I'm Jamie Wade. I'm a Front-end Developer based in the UK, working with Craft CMS, Tailwind, Gatsby, and Alpine.js.</p>
